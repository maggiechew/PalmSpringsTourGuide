...
const AvatarMenu = ({ visible, handleMenu, navigation, userStats }) => {
  ...
  const { sound, setSound } = useSiteUserContext();
  ...
  return (
    <Modal style={styles.avatarModal} visible={visible} onDismiss={handleMenu}>
      ...
      <View>
        ...
        {allFound ? (
          <Text style={styles.modalText}>
            You have discovered {allFound}% of all available sites
          </Text>
        ) : null}
        <View style={styles.bottom}>
          <Button
            style={styles.avatarButton}
            onPress={() => navigation.navigate('MySites')}
          >
            <Text style={styles.avatarButtonText}>My Sites Collection</Text>
          </Button>
